...
class WeiPayController extends Controller
{
    ...
    public $weixin_url='https://api.mch.weixin.qq.com/pay/unifiedorder';
    public $notify_url='http://1809lianshijie.comcto.com/notify';
    //微信支付测试
    public function text(){
        ...
        $rs = $this->postXmlCurl($xml, $this->weixin_url, $useCert = false, $second = 30);
